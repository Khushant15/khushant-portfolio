...
export default function Hero() {
  const words = [
    ...
    "Exploring Firebase, Kotlin & Angular",
    "Building UI with React & Tailwind CSS",
    "Debugging Enthusiast | Problem Solver",
    "Learning MERN Stack & Backend APIs",
  ];

  const [code] = useState(`
const profile = {
    name: 'Khushant Sharma',
    title: 'Python Developer | Full Stack Learner | Firebase Enthusiast',
    skills: [
        'Python', 'JavaScript', 'HTML', 'CSS',
        'React', 'Tailwind', 'Angular', 'Firebase',
        'Java', 'Node.js', 'GitHub', 'VS Code'
    ],
    eagerToLearn: true,
    teamPlayer: true,
    projectBuilder: true,
    currentlyLearning: ['MERN Stack', 'Kotlin', 'Backend APIs'],
    hireable: function() {
        return (
            this.eagerToLearn &&
            this.projectBuilder &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Passionate about coding, debugging & building projects. Learning full stack
                  dev with a focus on modern tools like Firebase, Angular, and Python.
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                <a
                  href="https://github.com/khushantsharma"
                  className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-teal-400 p-0.5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-teal-400">
                ...
                <a
                  href="/Khushant_Resume.pdf" // update this with your resume path
                  download
                ...
                >
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 border border-gray-700/50 group-hover:bg-gradient-to-r group-hover:from-gray-800 group-hover:to-gray-700">
